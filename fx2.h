...
// Added the following defines to stop VS Code from generating squiggle errors for these SDCC/8051 specific keywords
// When the SDCC compiler runs it defines __SDCC and hence these defines are skipped
#ifndef __SDCC
...
extern BYTE EZUSB_WriteI2C(BYTE addr, WORD length, BYTE *dat);
extern BYTE EZUSB_ReadI2C(BYTE addr, WORD length, BYTE *dat);
