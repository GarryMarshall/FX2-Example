;;-----------------------------------------------------------------------------
;;   File:      descriptor-tables.asm
;;   Contents:  This file contains descriptor data tables.
;;              Just 02(OUT) in Fullspeed, bu 02(OUT) and 06(IN) in Highspeed
;;              so that it is obvious in cyControl which mode is active
;;-----------------------------------------------------------------------------
...
;; Interface Descriptor (just 02 in full speed)
      .db   DSCR_INTRFC_LEN   ;; Descriptor length
      .db   DSCR_INTRFC       ;; Descriptor type
      .db   0                 ;; Zero-based index of this interface
      .db   0                 ;; Alternate setting
